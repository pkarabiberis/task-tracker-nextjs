import { FilterIcon, Grid3X3, List, Share2, Table } from "lucide-react";
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <input
              ...
              className="rounder-md border py-1 pl-10 pr-4 focus:outline-none dark:border-dark-secondary dark:bg-dark-secondary dark:text-white"
            />
...
function TabButton({ activeTab, icon, name, setActiveTab }: TabButtonProps) {
